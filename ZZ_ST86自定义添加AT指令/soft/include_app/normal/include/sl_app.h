...
struct FUNCPTR {
  ...
  SL_WIFI_CALLBACK* (*SL_WifiGetCb_p)(void);
  S32 (*SL_WifiInit_p)(SL_WIFI_CALLBACK *CB);
  S32 (*SL_wifi_power_on_p)(SL_WIFI_PWRON_MODE_t mode);
  S32 (*SL_WifiPowerOn_p)(U8 *ucpMacAddr, SL_WIFI_PWRON_MODE_t mode);
  S32 (*SL_WifiPowerOff_p)(void);
  S32 (*SL_WifiScan_p)(void);
  S32 (*SL_WifiConnectAp_p)(SL_WIFI_BSS_DESC_t *pWifiBssDesc, U8 *ucpPasswd, U8 ucLen);
  S32 (*SL_WifiDisconnectAp_p)(void);
  S32 (*SL_WifiDhcp_p)(void);
  S32 (*SL_WifiSendMacData_p)(U32* pulMacData, U16 usLen, U8 ucType);
  SL_WIFI_PWRON_MODE_t (*SL_WifiGetPwrOnMode_p)(void);
  S32 (*SL_WifiSetTxPower_p)(U16 usDiv, U16 usBase);
};
